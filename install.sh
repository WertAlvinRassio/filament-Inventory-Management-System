...
sudo pip3 install flask openpyxl Adafruit-Blinka adafruit-circuitpython-pn532 adafruit-circuitpython-tca9548a adafruit-circuitpython-hdc302x cedargrove-nau7802
